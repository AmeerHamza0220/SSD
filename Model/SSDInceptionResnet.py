...
from BaseNet.InceptionResnet_v2 import InceptionResnet
from layers.AnchorBox import AnchorBoxes
from layers.DecodeDetection import DecodeDetections

def ssd_inceptionResnet(image_size,
            n_classes,
            mode='training',
    ...
    conv4_3_norm_mbox_conf = Conv2D(n_boxes[0] * n_classes, (3, 3), padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv4_3_norm_mbox_conf')(conv9_2)
    ...
    conv4_3_norm_mbox_loc = Conv2D(n_boxes[0] * 4, (3, 3), padding='same', kernel_initializer='he_normal', kernel_regularizer=l2(l2_reg), name='conv4_3_norm_mbox_loc')(conv9_2)
